...
## Project Structure
    ...
    ├── testapiautoconnecto_87340  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_87340`
...
2. Clone this repo and `cd testapiautoconnecto_87340`
